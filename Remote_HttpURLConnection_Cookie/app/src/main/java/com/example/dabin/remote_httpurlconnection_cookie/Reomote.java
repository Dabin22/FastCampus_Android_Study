...
public class Reomote {
    ...
    static final String COOKIEURL = "Localhost";
    ...
    public static String postData(String webUrl, Map params, String method) throws IOException{
        ...
        if(cookies != null && cookies.size() >0){
            for(String cookie : cookies)
            {
                ...
                cookieManager.getCookieStore().add(URI.create(COOKIEURL), HttpCookie.parse(cookie).get(0));
            }
        }

        //전체 헤더 로그로 보기
//        ArrayList<String> keysett = new ArrayList<>(headers.keySet());
//
