...
public class PlaceSearchActivity extends AppCompatActivity implements PlaceSelectionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout touch_layout = (LinearLayout)findViewById(R.id.touch_layout);
        touch_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                setResult(FragmentPost.REQ_CODE_ADDRESS,intent);
                finish();
            }
        });
